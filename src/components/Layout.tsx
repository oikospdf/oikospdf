            ...
            <main className="container mx-auto px-4 py-12 max-w-4xl">
                <div className="space-y-8">
                    <div className="text-center space-y-4">
                        ...
                        <p className="text-muted-foreground">
                            This page does not have any ad or tracking, so we do not monetize it in any way. If you want to support us so we can improve this page and build new tools, please consider buying us a coffee, supporting us on Patreon or donating us with crypto.
                        </p>
                        <p className="text-muted-foreground">
                            If you have any suggestion, question, bug report or feature request, please open an issue on GitHub or contact us on contact@oikospdf.com.
                        </p>
                    </div>
                </div>
            </main>
